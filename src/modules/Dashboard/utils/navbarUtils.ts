...
export const buttons: urlProps[] = [
    {
        ...
        title: 'Model School',
        roles: [roles.SUPER_ADMIN, roles.ADMIN, roles.HQ_STAFF, roles.ZONAL_COORDINATOR, roles.DISTRICT_COORDINATOR, roles.PROGRAMME_EXECUTIVE]
    },
    {
    ...
    },
    {
        ...
        title: 'Internship',
        roles: [roles.SUPER_ADMIN, roles.ADMIN, roles.HQ_STAFF, roles.ZONAL_COORDINATOR, roles.DISTRICT_COORDINATOR, roles.PROGRAMME_EXECUTIVE, roles.INTERN]
    },
    {
        icon: 'fa-flat',
