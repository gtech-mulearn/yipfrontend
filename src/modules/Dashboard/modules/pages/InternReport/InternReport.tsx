...
const TableTitleList = ["District", 'No. of Pre-Registrations ', "No. of Active Interns", 'No.of Visited', 'No.of Events Scheduled', 'No.of Events Completed']
const orderBy: (keyof reportProps)[] = ['district', 'pre_registration', 'no_of_interns', 'no_of_club_visited', 'no_of_events_scheduled', 'no_of_events_completed']
const styleHead = {
    unOrder: 'fa-sort',
